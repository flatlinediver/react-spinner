...
describe('Spinner position', () => {
    ...
    it('renders spinner with position absolute and centered, ignoring top/left/bottom/right', () => {
        const { queryByTestId } = render(<Spinner position="absolute" center top="300px" left="300px" bottom="300px" right="300px"/>);
        expect(queryByTestId('spinner')).toHaveStyle(`
            position: absolute;
            top: 50%;
            left: 50%;
    ...
    it('renders spinner with position fixed and centered, ignoring top/left/bottom/right', () => {
        const { queryByTestId } = render(<Spinner position="fixed" center top="300px" left="300px" bottom="300px" right="300px"/>);
        expect(queryByTestId('spinner')).toHaveStyle(`
            position: fixed;
            top: 50%;
            left: 50%;
